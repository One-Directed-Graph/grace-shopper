            ...
            <div className="col-lg-6">
                ...
                <div className="panel-collapse collapse login_form" id="loginform">
                    <div className="panel-body">
                    	...
                    	<form method="post" onSubmit={(e)=>{handleSubmit(e,this.state.name,this.state.password)}}>
                            <div className="form-group">
                                <input type="text" required="" className="form-control" name="email" placeholder="Username Or Email" value={this.state.name} onChange={(e)=>{ this.setState({name: e.target.value})}}/>
                            </div>
                            <div className="form-group">
                                <input className="form-control" required="" type="password" name="password" placeholder="Password" value={this.state.password} onChange={(e)=>{ this.setState({password: e.target.value})}}/>
                            </div>
        ...
        <div className="row">
        	<div className="col-md-6">
                ...
                <form method="post">
                    ...
                    <div className="form-group">
                        <input type="text" className="form-control" name="billing_address" required="" placeholder="Address *"/>
                    </div>
                    <div className="form-group">
                        <input type="text" className="form-control" name="billing_address2" required="" placeholder="Address line2"/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        <div className="chek-form">
                            <div className="custome-checkbox">
                                ...
                                <label className="form-check-label label_info" for="createaccount"><span>Create an account?</span></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="ship_detail">
                    	...
                    	<div className="chek-form">
                            <div className="custome-checkbox">
                                ...
                                <label className="form-check-label label_info" for="differentaddress"><span>Ship to a different address?</span></label>
                            </div>
                        </div>
                    </div>
            ...
            <div className="col-md-6">
                <div className="order_review">
                  ...
                  <td>{item.product.title} <span className="product-qty">x {item.quantity}</span></td>
                    <td>${((item.price*1)*(item.quantity)).toFixed(2)}</td>
                  </tr>)
                  }):''}
                            ...
                            <tfoot>
                                <tr>
                                    <th>SubTotal</th>
                                    <td className="product-subtotal">{this.total().total}</td>
                                </tr>
                                <tr>
                                    <th>Shipping</th>
                                    <td>Free Shipping</td>
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td className="product-subtotal">{this.total().totalTax}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
